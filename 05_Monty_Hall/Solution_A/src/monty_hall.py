...
if __name__ == "__main__":
    ...
    num_wins_with_switching, num_wins_without_switching = simulate_game(number_of_game)
    
    print(f"Win rate with switching: {num_wins_with_switching / number_of_game * 100:.2f} %")
    print(f"Win rate without switching: {num_wins_without_switching / number_of_game * 100:.2f} %")
